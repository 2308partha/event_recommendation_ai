  ...
  return (
    <div className="container mx-auto p-6 max-w-6xl relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto z-10 relative">
        ...
        <Tabs defaultValue="attendees" className="w-full relative z-10">
          <TabsList className="bg-black/20 mb-6">
            <TabsTrigger value="attendees">Registered Attendees ({attendees.length})</TabsTrigger>
            <TabsTrigger value="marketplace">Marketplace AI Matches</TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="marketplace">
            {id && <MarketplaceAssistant eventId={id} />}
          </TabsContent>
        </Tabs>
      </div>
    </div>
